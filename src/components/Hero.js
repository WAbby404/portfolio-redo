      ...
      <div className="hero-wrapper" id="tsparticles">
        ...
        <Fade delay={1100}>
          <p className="hero-paragraph">
            I specialize in building <span>React</span>, <span>JavaScript</span>
            , <span>Figma</span> and <span>Cypress</span> web apps. My current
            interests include <span>TypeScript</span>, <span>Material UI</span>{" "}
