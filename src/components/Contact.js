          ...
          <Fade>
            <div className="contact-intro" id="contact">
              ...
              <p className="contact-paragraph">
                If you are interested in my work, shoot me an email! I post
                updates to my site, github and social medias frequently, and am
                constantly working on new projects. I would love to hear from
          ...
          <div className="contact-info-flex">
            <div className="contact-info">
              <Fade>
                ...
                <a
                  className="contact-link"
                  href="https://www.linkedin.com/in/abbywaddell4042/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  className="contact-link"
                  href="https://github.com/WAbby404"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <Fade>
              <div>
                <form className="contact-form" ref={form} onSubmit={sendEmail}>
                  ...
                  {success ? (
                    <div className="success-box">Email was a success!</div>
                  ) : (
                    <div className="hide">Email was a success!</div>
                  )}
                </form>
              </div>
            </Fade>
